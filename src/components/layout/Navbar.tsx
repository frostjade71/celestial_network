      ...
      <div className="flex justify-between items-center px-8 py-4 max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-primary to-primary-container text-on-primary px-5 py-1.5 rounded-full font-bold text-xs flex items-center gap-2 shadow-lg shadow-primary/20"
          >
